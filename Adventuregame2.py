...
def intro():
  ...
  "next morning in the woods. Head spinning and " 
  "about to be sick, you stand and try to remember what happened, "
  "and how you ended up here. The peace quickly fades when you hear a "
  "strange sound coming from behind you. A slobbering Ogre is "
  "running towards you. What do yo udo next:")
  time.sleep(1)
  print ("""  A. Grab a nearby rock and throw it at the Ogre
  B. Lie down and give up.
  C. Run""")
...
def option_rock(): 
  print ("\nThe Ogre is stunned, but regains control. He begins "
  "stomping towards you again. What do you do next:")
  time.sleep(1)
  print ("""  A. Run
...
def option_cave():
  ...
  if choice in answer_A:
    ...
    "Ogre's can see very well in the dark, right? Not sure, but "
    "I'm going with YES, so...\n\nYou died!")
  elif choice in answer_B:
   if sword > 0:
    print ("\nYou laid in wait. The shimmering sword attracted "
    "the Ogre, which thought you were no match. As he walked "
    "closer and closer, your heart beat rapidly. As the Ogre "
    ...
    print ("As the Ogre enters the dark cave, you sliently "
    "sneak out. You're several feet away, but the Ogre turns "
...
def option_run():
  print ("\nYou run as quickly as possible, but the Ogre "
...
def option_town():
  ...
  "behind a delapitated building, waiting for the Ogre to come "
  ...
  if flower > 0:
    ...
    "hoping it will stop the orc. It does! The Ogre was looking "
    "for love. "
